...
const SecondLayer = () => {
  return (
    <div className='bg-[#CFD9E6]'>
        ...
        <p className='p-6'>At Limo Geneva Sarl, we help business executives and <br /> leisure travellers put it all together. We take you from your <br /> doorsteps to the airport, to event destinations, to local tour <br /> sites, choice hotels, niche markets and everywhere you <br /> want to go around Geneva. With us, you know you'd get the <br /> best ride in town. </p>
        <img src={SecondCar} alt='' className='w-[500px] h-[300px] p-6'/>
        </div>
        </div>
    </div>
  )
