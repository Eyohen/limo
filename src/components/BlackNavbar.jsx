...
const BlackNavbar = () => {
  ...
  return (
    <div className={`h-20 items-center fixed ${ window.scrollY > 10 ? "bg-black" : "bg-transparent" } z-20 w-full`}>
...
<div className="flex gap-9 items-center">
   ...
   <Link to={'/'}> <p className='hidden md:block bg-gray-400  text-white text-lg px-10 py-2'>English</p></Link>
    ...
    <Link to={'/services'}><p className='hidden md:block text-white text-lg font-medium border border-[#BA8565] px-3 py-2 hover:bg-white hover:text-black hover:border-black'>Reservation</p></Link>
