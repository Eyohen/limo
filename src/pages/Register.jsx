...
const Register = () => {
  ...
  return (
    ...
    <div className="flex md:flex-row flex-col justify-center mx-auto md:space-x-12 items-center mt-6 md:mt-0">
         ...
         <label for="first_name" class="block md:mr-[260px] mr-[170px]">Full Name</label>
            <input onChange={(e)=>setFirstName(e.target.value)} type="text" id="first_name" class="bg-[#FAEFE9] border border-gray-300 text-gray-900 text-sm rounded-lg block w-64 md:w-[350px] p-2.5" placeholder="e.g johndoe@gmail.com" required />
            ...
            <label for="first_name" class="block md:mr-[270px] mr-[180px]">Password</label>
            ...
            <label for="first_name" class="block mr-[120px] md:mr-[215px]">Confirm Password</label>
            <input onChange={(e)=>setPassword(e.target.value)} type="text" id="first_name" class="bg-[#FAEFE9] border border-gray-300 text-gray-900 text-sm rounded-lg block w-64 md:w-[350px] p-2.5" placeholder="******" required />
