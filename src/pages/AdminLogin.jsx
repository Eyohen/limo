...
const AdminLogin = () => {
  ...
  return (
    ...
    <h1 className="text-3xl md:text-3xl font-bold"><Link to="/home" className="text-black font-Comfortaa">Limo</Link></h1>
   
    </div>
<div className="w-full flex justify-center items-center h-[80vh] ">
       <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
         <h1 className="text-xl font-bold text-left font-Comfortaa text-black">Admin Login</h1>
         <input onChange={(e)=>setEmail(e.target.value)} className="w-full px-4 py-2  border border-gray-600 rounded-lg" type="text" placeholder="Enter your email" />
